...
function Checkout({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <Button style={styles.button} title="Submit Order" accessibilityLabel="Clicking this button will proceed to the order screen" color="blue" onPress={() => navigation.navigate('Login')}/>
